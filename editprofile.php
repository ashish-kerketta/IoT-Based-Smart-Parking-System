...
<div class="form-group">
  <label class="col-md-4 control-label" for="radios">Vehicle?</label>
  <div class="col-md-4"> 
    <label class="radio-inline" for="car1">
      <input type="radio" name="radios" id="car1" value="1" checked="checked">
      1 Car
    </label> 
    <label class="radio-inline" for="car2">
      <input type="radio" name="radios" id="car2" value="2">
      2 Car
    </label>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="Brand">Car Brand</label>  
  <div class="col-md-4">
  <div class="input-group">
       <div class="input-group-addon">
     <i class="fa fa-sticky-note-o"></i>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="Colour">Car Colour</label>  
  <div class="col-md-4">
  <div class="input-group">
       <div class="input-group-addon">
     <i class="fa fa-sticky-note-o"></i> 
       </div>
   <input id="Colour" name="Colour" type="text" placeholder="Colour" class="form-control input-md">
      </div>
  </div>
</div>

<div class="form-group">
  <label class="col-md-4 control-label" for="Plate No.">Plate No.</label>  
  <div class="col-md-4">
  <div class="input-group">
       <div class="input-group-addon">
     <i class="fa fa-sticky-note-o"></i> 
       </div>
   <input id="Plate No." name="Plate No." type="text" placeholder="Plate No." class="form-control input-md">
      </div>
  </div>
</div>

<div class="form-group">
  <label class="col-md-4 control-label" for="Registration Certification No.">Registration Certification No.</label>  
  <div class="col-md-4">
  <div class="input-group">
       <div class="input-group-addon">
     <i class="fa fa-sticky-note-o"></i>
       </div>
   <input id="Registration Certification No." name="Registration Certification No." type="text" placeholder="Registration Certification No." class="form-control input-md">
      </div> 
  </div>
</div>
